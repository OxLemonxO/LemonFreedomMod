...
public class AntiSpam extends FreedomService
{
    ...
    public void onAsyncPlayerChat(AsyncPlayerChatEvent event)
    {
        ...
        {
            FSync.playerMsg(player, "Please do not repeat messages, it does get annoying.");
            event.setCancelled(true);
            return;
        }
    ...
    public void onPlayerCommandPreprocess(PlayerCommandPreprocessEvent event)
    {
        ...
        {
            FUtil.playerMsg(player, "Your commands have been blocked by an admin. They are likely to be unblocked soon.", ChatColor.RED);
            event.setCancelled(true);
            return;
        }
