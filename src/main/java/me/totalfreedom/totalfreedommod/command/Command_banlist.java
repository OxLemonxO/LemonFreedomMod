...
@CommandParameters(description = "Shows all banned player names. Executives may optionally use 'purge' to clear the list.", usage = "/<command> [purge]")
