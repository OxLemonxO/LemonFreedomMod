...
public class LoginProcess extends FreedomService
{
    ...
    public void onPlayerLogin(PlayerLoginEvent event)
    {
        ...
        {
            event.disallow(PlayerLoginEvent.Result.KICK_OTHER, "Server is temporarily open to admins only, please check back soon.");
            return;
        }
        ...
        if (lockdownEnabled)
        {
            event.disallow(PlayerLoginEvent.Result.KICK_OTHER, "Server is currently in lockdown mode, please check back soon.");
            return;
        }
